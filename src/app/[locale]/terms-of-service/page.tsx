...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.pokemonrejuvenation.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Pokémon Rejuvenation Wiki",
    description: "Read the Terms of Service for Pokémon Rejuvenation Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Pokémon Rejuvenation Wiki",
      title: "Terms of Service - Pokémon Rejuvenation Wiki",
      description: "Terms and conditions for using Pokémon Rejuvenation Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Pokémon Rejuvenation Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Pokémon Rejuvenation Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Pokémon Rejuvenation Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Pokémon Rejuvenation Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Pokémon Rejuvenation Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Pokémon fan RPG "Pokémon Rejuvenation". Our services include, but are not limited to:
            </p>
            <ul>
              <li>V14 chapter walkthroughs</li>
              <li>Field Effects and Crest guides</li>
              <li>Pokémon locations and Aevian Forms</li>
              <li>Boss and gym battle guides</li>
              <li>Puzzle and password solutions</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Pokémon Rejuvenation Wiki is NOT affiliated with, endorsed by, or associated with
              Nintendo, Game Freak, and The Pokémon Company or the official developers of Pokémon Rejuvenation. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Pokémon Rejuvenation Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Nintendo, Game Freak, and The Pokémon Company and/or the developers of Pokémon Rejuvenation. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Game version availability and updates may change without notice. We are not responsible for download access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, POKÉMON REJUVENATION WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Pokémon Rejuvenation Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@pokemonrejuvenation.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@pokemonrejuvenation.wiki</a>
            </p>
            <p>
