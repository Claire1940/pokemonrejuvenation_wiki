...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Pokémon Rejuvenation Wiki',
    description: 'Copyright and intellectual property information for Pokémon Rejuvenation Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Pokémon Rejuvenation Wiki',
      description: 'Copyright and intellectual property information for Pokémon Rejuvenation Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Pokémon Rejuvenation Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Pokémon Rejuvenation Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Pokémon Rejuvenation Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Nintendo / Game Freak / The Pokémon Company</strong> - Owners of the Pokémon franchise</li>
              <li><strong>Reborn Evolved Community</strong> - Creators of the Pokémon Rejuvenation fan game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Pokémon</strong> - Trademark of Nintendo, Game Freak, and The Pokémon Company</li>
              <li><strong>Pokémon Rejuvenation</strong> - Fan game by the Reborn Evolved community</li>
              <li><strong>Pokémon Rejuvenation Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Pokémon Rejuvenation Wiki.
            </p>
            ...
            <p>
              ...
              Pokémon Rejuvenation Wiki<br />
              Email: <a href="mailto:dmca@pokemonrejuvenation.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@pokemonrejuvenation.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Pokémon Rejuvenation Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Pokémon Rejuvenation Wiki (pokemonrejuvenation.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@pokemonrejuvenation.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@pokemonrejuvenation.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@pokemonrejuvenation.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@pokemonrejuvenation.wiki</a>
            </p>
            <p>
